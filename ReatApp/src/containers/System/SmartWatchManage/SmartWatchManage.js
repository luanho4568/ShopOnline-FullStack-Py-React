...
import ModalTablet from "./ModalSmartWatch";
import * as actions from "../../../store/actions";
import ModalEditTablet from "./ModalEditSmartWatch";
...
class SmartWatchManage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arrProductPhone: [],
    ...
    componentDidMount() {
        this.props.fetchAllProductStartRedux("C4");
    ...
    createNewProduct = async (data) => {
        this.props.createNewProductRedux(data, "C4");
    };

    handleDeleteProduct = async (product) => {
        await this.props.deleteOneProductRedux(product, "C4");
    };
    ...
    doEditProduct = async (product) => {
        await this.props.editOneProductRedux(product, "C4");
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(SmartWatchManage);

...
import ModalTablet from "./ModalScreen";
import * as actions from "../../../store/actions";
import ModalEditTablet from "./ModalEditScreen";
...
class ScreenManage extends Component {
    ...
    componentDidMount() {
        this.props.fetchAllProductStartRedux("C8");
    ...
    createNewProduct = async (data) => {
        this.props.createNewProductRedux(data, "C8");
    };

    handleDeleteProduct = async (product) => {
        await this.props.deleteOneProductRedux(product, "C8");
    };
    ...
    doEditProduct = async (product) => {
        await this.props.editOneProductRedux(product, "C8");
    };

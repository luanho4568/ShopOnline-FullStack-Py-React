...
import ModalTablet from "./ModalBluetooth";
import * as actions from "../../../store/actions";
import ModalEditTablet from "./ModalEditBluetooth";
...
class BluetoothManage extends Component {
    ...
    componentDidMount() {
        this.props.fetchAllProductStartRedux("C5");
    ...
    createNewProduct = async (data) => {
        this.props.createNewProductRedux(data, "C5");
    };

    handleDeleteProduct = async (product) => {
        await this.props.deleteOneProductRedux(product, "C5");
    };
    ...
    doEditProduct = async (product) => {
        await this.props.editOneProductRedux(product, "C5");
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(BluetoothManage);

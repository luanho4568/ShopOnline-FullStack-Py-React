...
import ModalTablet from "./ModalKeyboard";
import * as actions from "../../../store/actions";
import ModalEditTablet from "./ModalEditKeyboard";
...
class KeyboardManage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arrProductPhone: [],
    ...
    componentDidMount() {
        this.props.fetchAllProductStartRedux("C6");
    ...
    createNewProduct = async (data) => {
        this.props.createNewProductRedux(data, "C6");
    };

    handleDeleteProduct = async (product) => {
        await this.props.deleteOneProductRedux(product, "C6");
    };
    ...
    doEditProduct = async (product) => {
        await this.props.editOneProductRedux(product, "C6");
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(KeyboardManage);
